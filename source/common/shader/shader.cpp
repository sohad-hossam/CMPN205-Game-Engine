...
bool our::ShaderProgram::attach(const std::string &filename, GLenum type) const {
    ...
    glShaderSource(shader, 1, &sourceCStr, nullptr); //This function is used to get the source of the shader it takes the id of the shader, how many source codes, pointer to the pointer of the filename
    glCompileShader(shader);

    std::cout<<checkForShaderCompilationErrors(shader)<<std::endl;
    glAttachShader(program, shader);
    //---------------------------------------//
    //when do i delete the shader?
...
bool our::ShaderProgram::link() const {
    ...
    std::cout << checkForLinkingErrors(program) << std::endl;
    //----------------------------------------//
    //TODO: Complete this function
